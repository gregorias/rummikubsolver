...
allTests = HU.TestList [
  ...
  , HU.TestLabel "shouldReturnNothingOnInvalidMoves0" 
      shouldReturnNothingOnInvalidMoves0
  , HU.TestLabel "shouldReturnNothingOnInvalidMoves1" 
      shouldReturnNothingOnInvalidMoves1
  , HU.TestLabel "shouldSolveTheRummikubCompletely" 
...
shouldReturnNothingOnInvalidMoves0 =
  Nothing HU.~=?  Game.modifyTableMay 3 (Game.ValueTile (1, Game.Red))
    Game.initialRummikubState

shouldReturnNothingOnInvalidMoves1 :: HU.Test
shouldReturnNothingOnInvalidMoves1 =
  Nothing HU.~=?  Game.modifyRackMay 3 (Game.ValueTile (1, Game.Red))
    Game.initialRummikubState
